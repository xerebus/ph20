...
def explicit_Euler(x_0, v_0, h, s, plot=False):
...
def analytic(x_0, v_0, h, s, plot=False):
    '''Given a starting position x_0 and velocity v_0, plots the position x
...
def implicit_Euler(x_0, v_0, h, s, plot=False):
    '''Given a starting position x_0 and velocity v_0, plots the position x
...
def global_error(x_0, v_0, h, s, method_a, method_b, plot=False):
...
def error_vs_h(x_0, v_0, h_0, s, method_a, method_b, plot=False):
...
def plot_phase(x_0, v_0, h, s, method):
...
def symplectic_Euler(x_0, v_0, h, s, plot=False):
    '''Given a starting position x_0 and velocity v_0, plots the position x
