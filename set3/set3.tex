...
\pythonex[firstline=4, lastline=24]{spring.py}
\end{minipage}
...
\begin{figure}
\includegraphics[width=\textwidth]{explicit_Euler.eps}
...
\begin{minipage}{\textwidth}
\pythonex[firstline=67, lastline=90]{spring.py}
\end{minipage}

\begin{figure}
\includegraphics[width=\textwidth]{explicit_Euler_error.eps}
...
\pythonex[firstline=92, lastline=113]{spring.py}
